...
!(function (n) {
    ...
    var e = (function () {
            ...
            var t, n, i, h, r, s, f, g, m, v, y, _, o, a, w, l;
            function b(e, t) {
                return o.call(e, t);
            }
            function c(e, t) {
            ...
            return (
                    ...
                    (r = function (e, t, n, i) {
                        ...
                        if (((c = S((i = i || e))), "undefined" == p || "function" == p)) {
                            for (t = !t.length && n.length ? ["require", "exports", "module"] : t, l = 0; l < t.length; l += 1)
                                if ("require" === (r = (a = f(t[l], c)).f)) d[l] = g.require(e);
                                else if ("exports" === r) (d[l] = g.exports(e)), (u = !0);
                                else if ("module" === r) o = d[l] = g.module(e);
                                else if (b(m, r) || b(v, r) || b(_, r)) d[l] = D(r);
                                else {
                                    if (!a.p) throw new Error(e + " missing " + r);
                                    a.p.load(a.n, x(i, !0), A(r), {}), (d[l] = m[r]);
                                }
                            (s = n ? n.apply(m[e], d) : void 0), e && (o && o.exports !== h && o.exports !== m[e] ? (m[e] = o.exports) : (s === h && u) || (m[e] = s));
                        } else e && (m[e] = n);
                    }),
                            ...
                            this.data.current(function (e) {
                                ...
                                t.$results.find(".select2-results__option[aria-selected]").each(function () {
                                    var e = h(this),
                                        ...
                                        n = "" + t.id;
                                    (null != t.element && t.element.selected) || (null == t.element && -1 < i.indexOf(n)) ? e.attr("aria-selected", "true") : e.attr("aria-selected", "false");
                                });
                            });
                        }),
                ...
                e.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function (o, e, a) {
                    function n(e, t) {
                        ...
                        (n.prototype.update = function (e) {
                            if ((this.clear(), 0 !== e.length)) {
                                for (var t = [], n = 0; n < e.length; n++) {
                                    ...
                                    s && o.attr("title", s), a.StoreData(o[0], "data", i), t.push(o);
                                }
                                ...
                                null != c.term && null == c.page
                                    ? e.call(this, c, function e(t, n) {
                                          for (var i = t.results, o = 0; o < i.length; o++) {
                                              ...
                                              if ((r.text || "").toUpperCase() === (c.term || "").toUpperCase() || s) return !n && ((t.data = i), void u(t));
                                          }
                                          if (n) return !0;
                                          var a = d.createTag(c);
                                          if (null != a) {
                ...
                e.define(
                    ...
                    function (l, r, s, a, c, u, d, p, h, f, g, t, m, v, y, _, w, b, $, x, A, D, S, O, C, E, L, T, q, e) {
                        function n() {
                            this.reset();
                        }
                        return (
                            (n.prototype.apply = function (e) {
                                if (
                                    ...
                                    0 !== e.minimumResultsForSearch && (e.dropdownAdapter = f.Decorate(e.dropdownAdapter, E)),
                                        ...
                                        (null == e.dropdownCssClass && null == e.dropdownCss && null == e.adaptDropdownCssClass) || (e.dropdownAdapter = f.Decorate(e.dropdownAdapter, q)),
                                        (e.dropdownAdapter = f.Decorate(e.dropdownAdapter, C));
                                }
                                null == e.selectionAdapter &&
                                    (e.multiple ? (e.selectionAdapter = a) : (e.selectionAdapter = s),
                                    ...
                                    (null == e.containerCssClass && null == e.containerCss && null == e.adaptContainerCssClass) || (e.selectionAdapter = f.Decorate(e.selectionAdapter, p)),
                ...
                (l = function (p) {
                    ...
                    function i(e) {
                        ...
                        if (
                            ...
                            "axis" in n && n.axis === n.HORIZONTAL_AXIS && ((r = -1 * s), (s = 0)),
                            (o = 0 === s ? r : s),
                            ...
                            if (
                                ((t = Math.max(Math.abs(s), Math.abs(r))),
                                (!f || t < f) && y(n, (f = t)) && (f /= 40),
                                y(n, t) && ((o /= 40), (r /= 40), (s /= 40)),
